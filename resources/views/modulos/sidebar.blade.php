    ...
    <div class="sidebar">
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link">
                        <i class="nav-icon fas fa-regular fa-hospital"></i>
                        <p>
                        Pabellón
                        <i class="end fas fa-angle-right"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link">
                                <i class="nav-icon far fa-solid fa-suitcase-medical"></i>
                                <p>5 Piso</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link">
                        <i class="nav-icon fas fa-solid fa-boxes-packing"></i>
                        <p>
                        Insumos
                        <i class="end fas fa-angle-right"></i>
                        </p>
                ...
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link">
                        <i class="nav-icon fas fa-solid fa-road-barrier"></i>
                        <p>
                        Brazalete
                        <i class="end fas fa-angle-right"></i>
                        </p>
