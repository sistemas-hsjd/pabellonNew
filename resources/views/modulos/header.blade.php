<head>
    ...
    <meta name="description" content="Pabellón Digital Hospital San Juan de Dios">
    ...
    @vite(['resources/assets/css/select2-bootstrap-5-theme.min.css', 'resources/assets/css/adminlte.css', 'resources/css/app.css'])
